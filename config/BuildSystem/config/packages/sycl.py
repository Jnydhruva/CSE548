...
class Configure(config.package.Package):
  ...
  def configureLibrary(self):
    ...
    with self.setCompilers.Language('SYCL'):
      ...
      flags = flags.replace('  ',' ') # canonicalize the flag
      self.devFlags = flags # record the device flags so that they can be checked when needed
    ...
    with self.setCompilers.Language(clanguage):
      if not self.setCompilers.isSYCL(compiler,self.log):
        ...
        self.setCompilers.addLinkerFlag(flags + ldFlags)
