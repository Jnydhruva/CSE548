...
static constexpr impl::MatMPIDense_CUPM<DeviceType::CUDA> mat_cupm{};

/*MC
  MATDENSECUDA - MATDENSECUDA = "densecuda" - A matrix type to be used for dense matrices on
  GPUs.
...
.seealso: `MATSEQDENSECUDA`, `MATMPIDENSECUDA`, `MATSEQDENSEHIP`, `MATMPIDENSEHIP`, `MATDENSE`
M*/

/*MC
  MATMPIDENSECUDA - MATMPIDENSECUDA = "mpidensecuda" - A matrix type to be used for distributed
...
.seealso: `MATMPIDENSE`, `MATSEQDENSE`, `MATSEQDENSECUDA`, `MATSEQDENSEHIP`
M*/
