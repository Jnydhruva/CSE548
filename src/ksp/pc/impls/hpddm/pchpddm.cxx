          ...
          if (overlap != -1) {
            ...
            if (subdomains) {
              *subA = *s;
              ...
              PetscCall(PCHPDDMCommunicationAvoidingPCASM_Private(data->levels[0]->pc, subA[0], PETSC_TRUE));
              PetscTryMethod(data->levels[0]->pc, "PCASMGetSubKSP_C", (PC, PetscInt *, PetscInt *, KSP **), (data->levels[0]->pc, &n, NULL, &ksp));
            ...
            if (!no_schur) {
              ...
              if (subdomains) {
                PetscCall(MatSchurComplementSetKSP(h->S, ksp[0]));
...
static PetscErrorCode MatProduct_AB_Harmonic(Mat A, Mat X, Mat Y, void *)
{
  Harmonic h;
  KSP      ksp;
  Mat      A01, Z, W;
...
static PetscErrorCode MatProduct_AtB_Harmonic(Mat A, Mat Y, Mat X, void *)
{
  Harmonic  h;
  KSP       ksp;
  Mat       A01, Z, W;
