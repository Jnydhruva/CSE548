...
/*TEST
    ...
    testset:
      ...
      nsize: 4
      args: -f ${DATAFILESPATH}/matrices/underworld32.gz -test_fs false -prefix_push fc_ -ksp_converged_reason -ksp_max_it 100 -ksp_pc_side right -pc_type hpddm -pc_hpddm_levels_1_svd_nsv 100 -pc_hpddm_levels_1_svd_relative_threshold 1e-5 -pc_hpddm_levels_1_sub_pc_type cholesky -pc_hpddm_coarse_pc_type cholesky -pc_hpddm_levels_1_sub_pc_factor_shift_type inblocks -prefix_pop
      test:
        suffix: hpddm_overlap_3
        args: -fc_pc_hpddm_harmonic_overlap 3 -fc_pc_hpddm_levels_1_pc_type asm -fc_pc_hpddm_levels_1_sub_schur_pc_type cholesky -fc_pc_hpddm_levels_1_sub_schur_ksp_type preonly -fc_pc_hpddm_levels_1_svd_type lanczos -fc_pc_hpddm_levels_1_sub_mat_schur_complement_ainv_type full -test_sbaij {{true false}shared output}
      test:
      ...
      test:
        ...
        output_file: output/ex11_hpddm_overlap_3.out
        args: -fc_pc_hpddm_harmonic_overlap 3 -fc_pc_hpddm_levels_1_sub_schur_pc_type cholesky -fc_pc_hpddm_levels_1_sub_schur_ksp_type preonly -fc_pc_hpddm_levels_1_svd_type randomized -fc_pc_hpddm_levels_1_svd_max_it 2 -fc_pc_hpddm_levels_1_svd_tol 1e-1 -fc_pc_hpddm_define_subdomains false -fc_pc_hpddm_levels_1_sub_harmonic_mat_schur_complement_ainv_type full -fc_pc_hpddm_levels_1_pc_type asm -fc_pc_hpddm_levels_1_sub_harmonic_pc_type cholesky -fc_pc_hpddm_levels_1_sub_harmonic_pc_factor_shift_type inblocks -fc_pc_hpddm_harmonic_overlap_no_schur true -fc_pc_hpddm_levels_1_sub_harmonic_ksp_type preonly -set_symmetry {{true false}shared output} -options_left false
      test:
        suffix: hpddm_overlap_3_no_schur_share_mumps
        requires: mumps
        output_file: output/ex11_hpddm_overlap_3.out
        args: -fc_pc_hpddm_harmonic_overlap 3 -fc_pc_hpddm_levels_1_svd_type lanczos -fc_pc_hpddm_harmonic_overlap_no_schur true -fc_pc_hpddm_levels_1_st_share_sub_ksp -fc_pc_hpddm_levels_1_sub_pc_factor_mat_solver_type {{petsc mumps}shared output}
      test:
        suffix: hpddm_overlap_3_no_schur_share_mkl_pardiso
        requires: mkl_pardiso
        output_file: output/ex11_hpddm_overlap_3.out
        args: -fc_pc_hpddm_harmonic_overlap 3 -fc_pc_hpddm_levels_1_sub_pc_type cholesky -fc_pc_hpddm_levels_1_svd_type lanczos -fc_pc_hpddm_harmonic_overlap_no_schur true -fc_pc_hpddm_levels_1_st_share_sub_ksp -fc_pc_hpddm_levels_1_sub_pc_factor_mat_solver_type mkl_pardiso
      test:
        suffix: hpddm_overlap_4
        filter: sed -e "s/Linear fc_ solve converged due to CONVERGED_RTOL iterations 1[1-35]/Linear fc_ solve converged due to CONVERGED_RTOL iterations 14/g"
        args: -fc_pc_hpddm_harmonic_overlap 4 -fc_pc_hpddm_levels_1_sub_schur_pc_type cholesky -fc_pc_hpddm_levels_1_sub_schur_ksp_type preonly -fc_pc_hpddm_levels_1_svd_type lanczos -fc_pc_hpddm_levels_1_sub_harmonic_mat_schur_complement_ainv_type full -fc_pc_hpddm_levels_1_sub_harmonic_pc_type cholesky -fc_pc_hpddm_levels_1_sub_harmonic_pc_factor_shift_type inblocks -fc_pc_hpddm_harmonic_overlap_no_schur {{true false}shared output} -test_sbaij {{true false}shared output} -options_left false -fc_pc_hpddm_define_subdomains false -fc_pc_hpddm_levels_1_pc_type asm
      test:
        suffix: hpddm_overlap_4_petsc
        output_file: output/ex11_hpddm_overlap_4.out
        filter: sed -e "s/Linear fc_ solve converged due to CONVERGED_RTOL iterations 1[1-35]/Linear fc_ solve converged due to CONVERGED_RTOL iterations 14/g" -e "s/did not converge due to DIVERGED_ITS iterations 30/converged due to CONVERGED_RTOL iterations 14/g"
        args: -fc_pc_hpddm_harmonic_overlap 4 -fc_pc_hpddm_levels_1_svd_type lanczos -fc_pc_hpddm_harmonic_overlap_no_schur false -fc_pc_hpddm_levels_1_sub_mat_schur_complement_ainv_type full -fc_pc_hpddm_levels_1_sub_pc_factor_mat_solver_type petsc -fc_ksp_max_it 30
